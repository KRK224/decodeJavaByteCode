...
public enum BytecodeSignatureEnum {
    ...
    VOID("V", "void", true), BOOLEAN("Z", "boolean", true), BYTE("B", "byte", true), CHAR("C",
        "char", true), SHORT("S",
        "short", true), INT("I", "int", true), LONG("J", "long", true), FLOAT("F", "float",
        true), DOUBLE("D",
        "double", true), OBJECT("L", "object", false), ARRAY("[", "array", false), GENERIC("T",
        "generic", false), WILDCARD("*", "?", true),
    EXTENDS("+", "? extends ", true), SUPER("-", "? super ", true), GENERIC_BOUND(":", " extends ",
        true);
